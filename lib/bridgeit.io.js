...
(function(b) {
	...
	b.$ = {
		...
		post: function(url, data, headers, isFormData, contentType){
			return new Promise(function(resolve, reject) {
	...
	services.storage = {
		...
		uploadBlob: function(params){
			return new Promise(function(resolve, reject) {
				...
				b.$.post(url, formData, null, true).then(function(response){
					services.auth.updateLastActiveTimestamp();
					resolve(response.uri);
				})['catch'](function(error){
					reject(error);
		...
		uploadFile: function(params){
			return new Promise(
				function(resolve, reject) {
					...
					b.$.post(url, null, formData, true).then(function(response){
						services.auth.updateLastActiveTimestamp();
						resolve(response.uri);
					})['catch'](function(error){
						reject(error);
