...
(function(b) {
	...
	services.documents = {
         ...
         * @param {Object} params.queryId The query to be executed, can be used to execute an existing query by id instead of using the query parameter
				...
				function(resolve, reject) {
					...
					var url = getRealmResourceURL(services.documentsURL, account, realm, 
						collection, token, params.ssl, {
                            ...
                            'queryId': params.queryId ? encodeURIComponent(JSON.stringify(params.queryId)) : ''
					});
