		...
		connect: function(params){
			return new Promise(function(resolve, reject) {
				...
				function saveCredentials(){
					v.setSessionStorageItem(btoa(ACCOUNT_KEY), btoa(voyent.io.auth.getLastKnownAccount()));
					v.setSessionStorageItem(btoa(REALM_KEY), btoa(voyent.io.auth.getLastKnownRealm()));
					v.setSessionStorageItem(btoa(USERNAME_KEY), btoa(params.username));
