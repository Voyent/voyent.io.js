...
(function(v) {
	...
	v.io.configureHosts = function(url){
		...
		v.io.scopeURL = baseURL + (isLocal ? ':55400' : '') + '/scope';
	};
	...
	v.io.scope = {
		/**
		 * Create or update data stored within realm scope.
		 *
		 * @memberOf voyent.io.scope
		 * @alias updateRealmData
		 * @param {Object} params params
		 ...
		 * @returns {String} The resource URI.
		 */
		updateRealmData: function(params) {
			return new Promise(
				function (resolve, reject) {
					params = params ? params : {};
					v.io.checkHost(params);
		...
		/**
		 * Create or update data stored within user scope.
		 *
		 * @memberOf voyent.io.scope
		...
		/**
		 * Create or update data stored within process scope.
		 *
		 * @memberOf voyent.io.scope
		 * @alias updateProcessData
		 * @param {Object} params params
		 ...
		 * @returns {String} The resource URI.
		 */
		updateProcessData: function(params) {
			return new Promise(
				function (resolve, reject) {
					params = params ? params : {};
					v.io.checkHost(params);
		...
		/**
		 * Create or update data stored within transaction scope.
		 *
		 * @memberOf voyent.io.scope
		 * @alias updateTransactionData
		 * @param {Object} params params
		 ...
		 * @returns {String} The resource URI.
		 */
		updateTransactionData: function(params) {
			return new Promise(
				function (resolve, reject) {
					params = params ? params : {};
					v.io.checkHost(params);
