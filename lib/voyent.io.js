	...
	v.io.admin = {
		...
		confirmAccount: function(params) {
		    return new Promise(function(resolve, reject) {
				...
				var protocol = params.ssl ? 'https://' : 'http://';
				var txParam = getTransactionURLParam();
				var url = protocol + v.io.authAdminURL + '/' + params.account + '/confirm' + (txParam ? '&' + txParam : '');
		...
		resendConfirmAccountEmail: function(params) {
		    return new Promise(function(resolve, reject) {
				...
				var protocol = params.ssl ? 'https://' : 'http://';
				var txParam = getTransactionURLParam();
				var url = protocol + v.io.authAdminURL + '/' 
		...
		resendConfirmRealmUserEmail: function(params) {
		    return new Promise(function(resolve, reject) {
				...
				var protocol = params.ssl ? 'https://' : 'http://';
				var txParam = getTransactionURLParam();
				var url = protocol + v.io.authAdminURL + '/' + params.account
				                   + '/realms/' + params.realm
